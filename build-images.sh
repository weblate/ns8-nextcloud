...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/redis:6.2.12-alpine docker.io/mariadb:10.6.16 docker.io/nginx:1.25.4-alpine ghcr.io/nethserver/nextcloud-app:${IMAGETAG}" \
    "${container}"
# Commit the image
